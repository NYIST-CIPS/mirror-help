...
将 :file:`/etc/apt/sources.list` 文件中默认的源地址 ``https://raspbian.raspberrypi.org/`` 替换为 ``https://mirror.nyist.edu.cn/raspbian/`` 即可。
...
Raspbian 链接
  ...
  :Bug Tracker: https://www.raspbian.org/RaspbianBugs
