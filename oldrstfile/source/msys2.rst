...
访问该镜像目录下的 ``distrib/`` 目录 (`x86_64 <https://mirror.nyist.edu.cn/msys2/distrib/x86_64/>`_ 、 `i686 <https://mirror.nyist.edu.cn/msys2/distrib/i686/>`_ )，找到名为 ``msys2-<架构>-<日期>.exe`` 的文件 （如 ``msys2-x86_64-20141113.exe`` ），下载安装即可。
